...
export default {
  ...
  methods: {
    ...
    onTab(i) {
      this.tabIndex = i;
      if (i === 0) {
        this.$router.push("/students/profession/select");
      } else if (i === 1) {
        this.$router.push("/students/profession/discipline");
      } else if (i === 2) {
        this.$router.push("/students/profession/universityLibrary");
      } else if (i === 3) {
        this.$router.push("/students/profession/dataCourse");
      }
    }
  }
};
