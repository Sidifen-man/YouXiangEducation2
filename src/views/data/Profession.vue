        ...
        <div class="tag-category">
          ...
          <div class="common-item search-job">
            <div class="sj">
              ...
              <span class="active" @click="condition.is_love=''">全部</span>
              <span
                class="yes label"
                :class="{selected: condition.is_love===1}"
                @click="condition.is_love=1"
              >是</span>
              <span
                class="no label"
                :class="{selected: condition.is_love===0}"
                @click="condition.is_love=0"
              >否</span>
            </div>
            <div class="hot">
              <span>查看热门:</span>
              ...
              <div class="li">
                <div class="work-cover">
                  <div class="label-button">
                    ...
                    <span class="collect"  @click="add_love(item)" :class="{active: item.is_love}"
                    ></span>
                  </div>
  ...
  methods: {
    ...
    getlist(index){
      ...
      const param = {
        ...
        dreamFlag: this.condition.is_love,
    ...
    start_detail(id) {
      this.$router.push(`/students/profession/pdetail/${id}`);
    },
