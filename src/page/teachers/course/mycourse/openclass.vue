    ...
    <el-dialog
      ...
      <ul class="class-list">
        <li
          ...
          <span v-if="item.chapterStatus == '0'"
            class="class-item__btn"
            :class="{'is-inclass': item.chapterStatus != '0'}"
            @click="handleClassBegin(item)">

            <img :src="item.chapterStatus != '0' ? inclass : beginClass"/>
          </span>
  ...
  export default {
    ...
    methods: {
      ...
      startEducation(){
        ...
        if (this.deleteObj.chapterStatus != '0') {
          ...
          _this.loading = true
            ...
            axios.post(teacherChapterStartApi, params,{
              headers: {
              ...
              if(code == 'success'){
                ...
                this.deleteObj.chapterStatus = "1"
